...
ActiveRecord::Schema.define(version: 20180204200036) do
  ...
  create_table "favourites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["flower_id"], name: "index_favourites_on_flower_id"
  ...
  create_table "sightings", force: :cascade do |t|
    ...
    t.index ["latitude"], name: "index_sightings_on_latitude"
    t.index ["longitude"], name: "index_sightings_on_longitude"
  ...
  add_foreign_key "favourites", "flowers"
